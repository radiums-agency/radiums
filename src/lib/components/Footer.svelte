...
<section id="footer">
	...
	<div class="footer-mid">
		<div class="mid-left">
			<ul>
				<li>
					<a href="https://web.facebook.com/profile.php?id=61556206816114" title="facebook" target="_blank">
...
<style>
	...
	.logo {
		font-size: clamp(30px, 10vw + 0.1rem, 15rem);
		text-align: center;
	}
